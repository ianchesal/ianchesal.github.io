...
This site was boostrapped from the excellent [jekyll-now](https://github.com/barryclark/jekyll-now/issues/new) project by [Barry Clark](https://github.com/barryclark). Thank you, Barry!
